...
Function SettingsFileNameForTarget() Export
	...
	Return "Sybchronization settings for SL (without conversion rules)";
...
// 
Function NodeFilterStructure(CorrespondentVersion, FormName) Export
...
// 
Function NodeDefaultValues(CorrespondentVersion, FormName) Export
...
//
Function DataTransferRestrictionDetails(NodeFilterStructure, CorrespondentVersion) Export
...
//
Function DefaultValueDetails(NodeDefaultValues, CorrespondentVersion) Export
...
Function NewDataExchangeCreationCommandTitle() Export
	...
	Return NStr("en = '1C:Subsystems library 2.2'");
...
Function ExportDataProcessorName() Export 

	Return "_DemoExportToSL21Handlers";	

EndFunction // ()

Function ImportDataProcessorName() Export

	Return "_DemoImportFromSL21Handlers";	

EndFunction // ()

Function ExchangeBriefInfo() Export
	
	Return NStr("en = 'Data sybchronization without conversion rules.'");

EndFunction

Function ExchangeDetailedInformation() Export
	
	Return "http://1c-dn.com/glossary/distributed_infobase/";
