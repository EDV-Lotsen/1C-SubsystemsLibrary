...
Procedure Print(ObjectArray, PrintParameters, PrintFormsCollection,
    ...
    If _DemoPrintManagement.NeedToPrintTemplate(PrintFormsCollection, "PurchaseOrder") Then
...
Function PrintTemplate(ObjectArray, PrintObjects)
   ...
   Selection = Query.Execute().Select();
	...
	Us = Catalogs.Counterparties.OurCompany;
	 ...
	 Template = _DemoPrintManagement.GetTemplate("Document.PurchaseOrder.PF_MXL_PurchaseOrder");
