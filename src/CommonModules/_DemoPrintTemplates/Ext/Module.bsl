...
Function ContactInfoDataset(Counterparty, Type, ShipTo) Export
	...
	If Type = "UsBill" Then
		Info.Insert("UsCode", Counterparty.Code);
		Info.Insert("UsName", Counterparty.Description);	
	...
	ElsIf Type = "ThemShip" Then
        Info.Insert("ThemCode", Counterparty.Code);
		Info.Insert("ThemName", Counterparty.Description);	
