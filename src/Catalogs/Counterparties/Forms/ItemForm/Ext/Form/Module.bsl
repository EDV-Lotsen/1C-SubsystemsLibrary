...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Object.Ref = Catalogs.Counterparties.OurCompany Then
...
&AtServer
// Checks if the user indicated if the counterparty is a customer, vendor, or both.
//
Procedure FillCheckProcessingAtServer(Cancel, CheckedAttributes)
		
	If Object.Vendor = False AND Object.Customer = False AND
		NOT Object.Ref = _DemoGeneralFunctions.GetOurCompany() Then
		
		Message = New UserMessage();
		Message.Text=NStr("en='Select if the counterparty is a customer, vendor, or both'");
