...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	OpenForm("Catalog.Users.Form.InfoBaseUsers", FormParameters, CommandExecuteParameters.Source, CommandExecuteParameters.Uniqueness, CommandExecuteParameters.Window);
