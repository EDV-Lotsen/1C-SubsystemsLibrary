...
Procedure ClearSelectedSettings()
	...
	User = DataProcessors.AppUserSettings.InfobaseUserName(Source);
...
Procedure ClearAllSettings()
	...
	Else
		...
		UserTable = DataProcessors.AppUserSettings.UsersToCopy("", UserTable, False, True);
	...
	DataProcessors.AppUserSettings.DeleteAppUserSettings(SettingsArray, Sources);
