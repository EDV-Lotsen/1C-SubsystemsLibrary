...
Procedure ImportAccounts(File)
	...
	For n= 1 To   TotalNRows -1 Do
		...
		If AccountTypeValue = _DemoGeneralFunctionsCached.BankAccountType() OR
			AccountTypeValue = _DemoGeneralFunctionsCached.ARAccountType() OR
			AccountTypeValue = _DemoGeneralFunctionsCached.APAccountType() Then
			
			NewAccount.Currency = _DemoGeneralFunctionsCached.DefaultCurrency();
		EndIf;
